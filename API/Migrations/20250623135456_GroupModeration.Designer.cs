...
namespace API.Migrations
{
    ...
    [Migration("20250623135456_GroupModeration")]
    partial class GroupModeration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.Entities.GroupMemberModeration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GroupMemberModerations");
                });
            ...
            modelBuilder.Entity("API.Models.Entities.GroupMessageModeration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GroupMessageModerations");
                });

            modelBuilder.Entity("API.Models.Entities.GroupModerationAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GroupModerationActions");
                });
            ...
            modelBuilder.Entity("API.Models.Entities.GroupTransactionComment", b =>
                {
                    ...
                    b.ToTable("GroupTransactionComments");
                });
            ...
            modelBuilder.Entity("API.Models.Entities.Post", b =>
                {
                    ...
                    b.Property<string>("TargetGroupIds")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("API.Models.Entities.PostCommentReply", b =>
                {
            ...
            modelBuilder.Entity("API.Models.Entities.GroupMemberModeration", b =>
                {
                    b.HasOne("API.Models.Entities.GroupMember", "GroupMember")
                        .WithMany()
                        .HasForeignKey("GroupMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Models.Entities.ApplicationUser", "Moderator")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Models.Entities.GroupModerationAction", b =>
                {
                    ...
                    b.HasOne("API.Models.Entities.ApplicationUser", "TargetUser")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Models.Entities.GroupTransactionComment", b =>
                {
                    b.HasOne("API.Models.Entities.GroupTransaction", "GroupTransaction")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("API.Models.Entities.PostCommentReply", b =>
                {
                    ...
                    b.HasOne("API.Models.Entities.PostComment", "Comment")
                        .WithMany("Replies")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Models.Entities.PostCommentReply", "ParentReply")
                        .WithMany("Replies")
